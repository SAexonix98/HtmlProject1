function validate_specific(input) {
  //var cf = document.getElementById("cf");
  var name = input.getAttribute("name");
  var reg;
  switch (name) {
    case "cf":
      reg = new RegExp(/^\D{6}\d{2}\D{1}\d{2}\D{1}\d{3}\D{1}$/gi)
      break;
    case "password":
      reg = new RegExp(/(?=.*[A-Z])(?=.*[a-z])(?=.*[\d].*[\d])(?=.*[\?|#|!|_].*[\?|#|!|_])[\w\W]{8,10}.*/g)
      break;
    case "username":
      reg = new RegExp(/(?=.*[A-Z])(?=.*[a-z])(?=.*[\d].*[\d])(?=.*[\?|-|@|_].*[\?|-|@|_])(?!.*\s.*)[\w\W]{8,10}.*/g)
      break;
    default:
      return false;
  }
...
function validate_generic(input) {
  ...
  if (input.value == "") {
    ...
    input.style.borderColor = "#2ecc71";
    validate_specific(input);
  }
}

function underAgeValidate(input) {
  // it will accept two types of format yyyy-mm-dd and yyyy/mm/dd
  var optimizedBirthday = input.value.replace(/-/g, "/");
  ...
  if (myAge < 18) {
    input.style.borderColor = "#e74c3c";
    alert("wajo si minorenn");
  } else {
    input.style.borderColor = "#2ecc71";
  }

}
const passwordConst = document.getElementById("submit-form-button")
passwordConst.addEventListener("click", () => {
  const newPassword = document.getElementById("confermaPassword");
...
function ShowInput() {
  ...
  var localita = document.getElementById("Comune").value;
  //APPUNTI
  ...
  //STAMPA SU PARAGRAFO
  var para = document.getElementById("cf");

  ///####################ANNO DATI##############################///

  var dataDiNascita = document.getElementById("data_di_nascita").value;
  ...
  //var femmina = false;
  //var maschio = true;
  var femmina = document.getElementById("female");
  var maschio = document.getElementById("male");
  ...
  document.getElementById("cf").value = CF_FX + lettera_controllo;
